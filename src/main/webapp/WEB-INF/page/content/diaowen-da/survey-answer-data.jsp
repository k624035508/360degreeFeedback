...
<body>
	...
	<div class="creatgeSurveyStepBody">
		<div class="creatgeSurveyStepContent bodyCenter">
			<ul class="createSsUl">
				<li>
					<a href="${ctx }/design/my-survey-design.action?surveyId=${surveyId}"  class="csscStep csscStep4"><span class="csscStepLeft" style="width: 36px">&nbsp;</span><span class="csscStepCenter">设计问卷</span></a>
				</li>
				<li><span class="csscStep csscStepLine"><span class="csscStepLeft">&nbsp;</span><span class="csscStepRight">&nbsp;</span></span></li>
				<li>
					<a href="${ctx }/design/my-collect.action?surveyId=${surveyId }"  class=" csscStep csscStep5"><span class="csscStepLeft" style="width: 36px">&nbsp;</span><span class="csscStepCenter">数据收集</span></a>
				</li>
				<li><span class="csscStep csscStepLine"><span class="csscStepLeft">&nbsp;</span><span class="csscStepRight">&nbsp;</span></span></li>
				<li><a href="${ctx }/da/survey-report!defaultReport.action?surveyId=${surveyId}"  class="csscStep csscStep6 active"><span class="csscStepLeft"  style="width: 36px">&nbsp;</span><span class="csscStepCenter">数据分析</span></a>
				</li>
			</ul>
		</div>
	</div>
			...
			<div class="surveyCollectMiddle">
				...
				<div class="surveyCollectTop">
					...
					<div class="surveyCollectInfoDiv">
						...
						创建时间：<span class="collectInfoSpan"><fmt:formatDate value="${survey.createDate }" pattern="yyyy.MM.dd" /> </span>
						</span>
					</div>
				</div>
