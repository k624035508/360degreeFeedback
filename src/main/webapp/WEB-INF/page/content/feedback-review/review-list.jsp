                ...
                <div class="surveyCollectMiddleContent">
                    <div style="padding: 25px 45px;overflow: auto;padding-top: 12px;">
                        ...
                        <div class="contacts_search" style="padding: 5px;color:#666565;margin-top: 15px;" >
                                <div style="padding-left: 30px;padding-top: 8px;padding-bottom: 30px;">
                                    <span style="float: left;">考核表管理</span>
                                    <div style="padding: 5px;color: #666565;text-align: right;float: right;margin-right: 20px;">
                                        <a href="${ctx }/review/design/feedback-review!input.action" class="user-plus active"><i class="fa fa-plus " aria-hidden="true"></i>&nbsp;新建考核表</a>
                                    </div>
                                </div>
                        </div>
                                ...
                                <div style="">
                                    <table class="contacts-table" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <th align="left">考核表名称</th>
                                            <th align="left"  width="80">创建者</th>
                                            ...
                                            <c:when test="${page.totalItems > 0}">
                                                ...
                                                <c:forEach items="${page.result }" var="en">
                                                    <tr>
                                                        ...
                                                        <td align="left"><fmt:formatDate value="${en.createDate }" pattern="yyyy-MM-dd HH:mm"/></td>
                                                        <%--<td align="left">${en.status ne 0 ? '可用':'不可用' }</td>--%>
                                                        <td align="center">收集中</td>
                                                        <td align="center">
                                                            <a class="btn btn-default" href="${ctx }/review/design/feedback-review!input.action?id=${en.id}" title="编辑"data-toggle="tooltip" data-placement="top" ><i class="fa fa-pencil-square-o"></i></a>
                                                            <a class="btn btn-default disUser_a" href="${ctx }/review/design/feedback-review!delete.action?id=${en.id}" title="删除"data-toggle="tooltip" data-placement="top" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                    ...
                                    <div style="padding-top: 15px;text-align: center;">
                                        <div class="btn-group">
                                            <c:if test="${page.pageNo > 1}">
                                                <a href="${ctx }/review/design/feedback-review.action?page.pageNo=${page.pageNo-1}" class="btn btn-default">&lt;</a>
                                            </c:if>
                                            <c:if test="${page.startpage > 1}">
                                                <a href="${ctx }/review/design/feedback-review.action?page.pageNo=1" class="btn btn-default">1</a>
                                            ...
                                            <c:forEach begin="${page.startpage }" end="${page.endpage }" var="en">
                                                <c:choose>
                                                    <c:when test="${page.pageNo eq en }"><a href="${ctx }/review/design/feedback-review.action?page.pageNo=${en }" class="btn btn-default" style="background: #D3DEED;">${en }</a></c:when>
                                                    <c:otherwise><a href="${ctx }/review/design/feedback-review.action?page.pageNo=${en}" class="btn btn-default">${en }</a></c:otherwise>
                                                </c:choose>
                                            </c:forEach>
                                            <c:if test="${page.totalPage > (page.endpage)}">
                                                ...
                                                <a href="${ctx }/review/design/feedback-review.action?page.pageNo=${page.totalPage}" class="btn btn-default">${page.totalPage }</a>
                                            </c:if>
