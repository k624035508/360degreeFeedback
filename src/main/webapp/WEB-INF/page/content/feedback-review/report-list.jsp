                                            ...
                                            <c:when test="${page.totalItems > 0}">
                                                ...
                                                <c:forEach items="${page.result }" var="en">
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a class="btn btn-default" href="${ctx }/report/feedback-report!report.action?reviewId=${en.id}" title="查看"data-toggle="tooltip" data-placement="top" ><i class="fa fa-pencil-square-o"></i></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
