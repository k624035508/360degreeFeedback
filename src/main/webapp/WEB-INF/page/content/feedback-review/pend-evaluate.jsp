...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            $(".header_menu ul li").eq(0).addClass("menu-select");
        })
    </script>
</head>
<body>
                                ...
                                <table class="contacts-table" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <c:forEach items="${list }" var="en">
                                        <tr>
                                            ...
                                            <td align="left"><a target="_blank" class="titleTag">${en.name }</a></td>
                                            <td align="left">
                                            ...
                                            <td align="left">
                                                <div class="btn-group surveyLeftBtnGroup">
                                                    <a class="btn btn-default" target="_blank"
                                                       href="${ctx }/feedback!answerFeedback.action?reviewId=${en.id}"
                                                       title="回答"data-toggle="tooltip" data-placement="top" >
