                    ...
                    <div style="padding: 25px 45px;overflow: auto;padding-top: 12px;">
                        ...
                        <div class="contacts_search" style="padding: 5px;color:#666565;margin-top: 15px;" >
                            <div style="padding-left: 30px;padding-top: 8px;padding-bottom: 30px;">
                                <span style="float: left;">测评报告列表</span>
                                    ...
                                    <div style="padding-top: 15px;text-align: center;">
                                        <div class="btn-group">
                                            <c:if test="${page.pageNo > 1}">
                                                <a href="${ctx }/statistics/feedback-statistics.action?page.pageNo=${page.pageNo-1}" class="btn btn-default">&lt;</a>
                                            </c:if>
                                            <c:if test="${page.startpage > 1}">
                                                <a href="${ctx }/statistics/feedback-statistics.action?page.pageNo=1" class="btn btn-default">1</a>
                                            ...
                                            <c:forEach begin="${page.startpage }" end="${page.endpage }" var="en">
                                                <c:choose>
                                                    <c:when test="${page.pageNo eq en }"><a href="${ctx }/statistics/feedback-statistics.action?page.pageNo=${en }" class="btn btn-default" style="background: #D3DEED;">${en }</a></c:when>
                                                    <c:otherwise><a href="${ctx }/statistics/feedback-statistics.action?page.pageNo=${en}" class="btn btn-default">${en }</a></c:otherwise>
                                                </c:choose>
                                            </c:forEach>
                                            <c:if test="${page.totalPage > (page.endpage)}">
                                                ...
                                                <a href="${ctx }/statistics/feedback-statistics.action?page.pageNo=${page.totalPage}" class="btn btn-default">${page.totalPage }</a>
                                            </c:if>
