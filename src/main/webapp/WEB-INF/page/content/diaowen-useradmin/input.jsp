									...
									<tr>
										<td valign="top" align="left" >
											<table class="ac-form-table">
												...
												<tr>
													<td width="80" align="right"><span class="red-color">*&nbsp;</span>部门</td>
													<td class="ac-input-td">
														<select name="department">
															<c:forEach items="${departmentList}" var="departmentList">
																<option value="${departmentList.id}"
																		<c:if test="${departmentList.id eq department}">selected</c:if>
												...
												<tr>
													<td width="80" align="right"><span class="red-color">*&nbsp;</span>权限级别</td>
													<td class="ac-input-td">
														<input type="radio" name="role" value="2"
															<c:if test='${role eq "2"}'>checked</c:if>
														>领导&nbsp;&nbsp;&nbsp;
