				...
				<div class="tabbarDialog">
					<div class="p_DialogContent">
						...
						<div class="p_DialogContentRoot">
								<div class="p_DialogContentItem"><label><input type="checkbox" name="effective" value="4"> 每个用户每天只能答一次</label></div>
								<div class="p_DialogContentItem"><label><input type="checkbox" name="effectiveIp" value="1"> 每个用户只能答一次</label></div>
