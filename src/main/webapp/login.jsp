...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var loginFormValidate=$("#loginForm").validate({
			rules:{
				username:{required:true,minlength:3,maxlength:60},
...
<div id="wrap" class="wrapLogin">
	...
	<div id="dwBody" >
		<div id="dwBodyContent" class="bodyCenter" style="background: none; margin-top: 80px;">
						   ...
						   <c:choose>
							...
							<div class="dlcLeft">
								...
								<div class="frmItem" style="padding: 6px 5px;">
									<label for="" class="frm_label">&nbsp;</label>
									<input type="submit"  value=" 登 录 " class="btnGreen" style="width: 306px;height: 45px;" />
								</div>
								...
								<%--<div class="frmItem" style="padding: 10px 5px;">--%>
									<%--<label for="" class="frm_label">&nbsp;</label>--%>
									<%--还没有账号&nbsp;&nbsp;<a href="${ctx}/sy/user/user-admin!input.action">免费注册</a>--%>
								<%--</div>--%>
						</div>
						<%--<div class="dlcRight">--%>
			...
			<shiro:user>
				<div id="dwLoginContent">
					<div class="dlcTitleBg" style="height: 58px;" ></div>
