...
import com.key.common.config.Global;
...
public class UploadUtils {
    ...
    public static String tempPath = basePath + TEMP_PATH;
    ...
    public static String getImgPath(){
        ...
        String url = "";
        url =  utils.getDirName() + "/";
        File saveDirFile = new File(Global.getUserfilesBaseDir()+basePath + "/" +url);
        ...
        url += ymd + "/";
        File dirFile = new File(Global.getUserfilesBaseDir()+url);
        if (!dirFile.exists()) {
            dirFile.mkdirs();
        }
        return url;
    ...
    private String validateFields(HttpServletRequest request) {
        ...
        // 文件保存目录URL
        saveUrl = Global.getConfig("userfile.prefix") + "/";
     ...
     */
//	@SuppressWarnings("unchecked")
    public static Map<String, Object> initFields(HttpServletRequest request) {
